...
export default function Footer({ onOpenDeveloperConsole }: FooterProps) {
  ...
  return (
    <footer className="border-t border-slate-200 dark:border-slate-300 bg-slate-100 dark:bg-slate-50 transition-colors duration-400 py-12 px-6 mt-12 relative z-10">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start mb-8">
          ...
          <div>
            <h4 className="text-sm font-bold text-slate-800 dark:text-slate-700 mb-3 uppercase tracking-wider">
              Developer & Project Specifications
            </h4>
            <div className="space-y-2">
              <div className="flex items-center gap-2 text-xs text-slate-600 dark:text-slate-400 font-medium">
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-500"></span>
                <span>Created by: <strong className="text-slate-800 dark:text-slate-700 font-bold">Mattaniah Ilunga</strong></span>
              </div>
              <div className="flex items-center gap-2 text-xs text-slate-600 dark:text-slate-400 font-medium">
                <span className="w-1.5 h-1.5 rounded-full bg-teal-500"></span>
                <span>Contact Email: <a href="mailto:mattaniahilunga@gmail.com" className="hover:underline text-emerald-600 dark:text-emerald-400 font-bold">mattaniahilunga@gmail.com</a></span>
              </div>
          ...
          <div className="flex flex-col items-start md:items-end">
            <button
              ...
              className="px-4 py-2 text-xs font-bold text-white bg-emerald-600 hover:bg-emerald-700 rounded-lg shadow-md transition-all duration-200 flex items-center gap-2 cursor-pointer"
            >
              <AlertCircle className="w-4 h-4" />
              Report System Issue
            </button>
            <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-2 text-start md:text-end font-medium">
              Issues will be directly routed to mattaniahilunga@gmail.com
            </p>
          </div>
        </div>
            ...
            >
              ...
              {isSuccess ? (
                <div className="flex flex-col items-center justify-center py-6 text-center">
                  ...
                  <p className="text-sm font-bold text-slate-900">Issue Transmitted Successfully!</p>
                  <p className="text-xs text-slate-500 mt-1 max-w-md">
                    Our notification engine has encrypted and scheduled this report. It is now safely queued for review by{' '}
                    <span className="font-mono text-emerald-600 dark:text-emerald-400 font-bold">mattaniahilunga@gmail.com</span>.
                  </p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full text-xs px-3 py-2 border border-slate-200 rounded-lg bg-white/50 dark:bg-slate-950/50 text-slate-900 focus:outline-none focus:ring-2 focus:ring-emerald-500 glass-input"
                      />
                    </div>
                    <div>
                      <label className="block text-xs font-bold text-slate-700 mb-1">
                  ...
                  <div className="md:col-span-2 flex justify-end">
                    <button
                      ...
                      className="px-4 py-2 text-xs font-bold text-white bg-emerald-600 hover:bg-emerald-700 rounded-lg flex items-center gap-2 transition-colors duration-200 disabled:opacity-50 cursor-pointer"
                    >
        ...
        <div className="pt-8 border-t border-slate-200 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-4 items-center">
            <span className="text-[10px] text-slate-500 font-mono flex items-center gap-1 font-bold">
              <Sparkles className="w-3 h-3 text-emerald-600 dark:text-emerald-400 animate-pulse" /> E2EE AES-GCM Encrypted Cloud Sync Active
            </span>
          </div>
        </div>
      </div>
